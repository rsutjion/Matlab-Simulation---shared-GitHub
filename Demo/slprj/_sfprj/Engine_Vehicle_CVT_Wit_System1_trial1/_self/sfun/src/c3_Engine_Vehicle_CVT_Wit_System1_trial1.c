...
#include <stddef.h>
#include "blas.h"
#include "Engine_Vehicle_CVT_Wit_System1_trial1_sfun.h"
#include "c3_Engine_Vehicle_CVT_Wit_System1_trial1.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Engine_Vehicle_CVT_Wit_System1_trial1_sfun_debug_macros.h"
...
static void initialize_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
static void initialize_params_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
static void enable_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
static void disable_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Engine_Vehicle_CVT_Wit_System1_trial
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
...
static void set_sim_state_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance,
   const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_Engine_Vehicle_CVT_Wit_System1_
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
static void finalize_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
static void sf_gateway_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
static void mdl_start_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
static void initSimStructsc3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance);
...
static uint8_T c3_e_emlrt_marshallIn
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance,
   const mxArray *c3_b_is_active_c3_Engine_Vehicle_CVT_Wit_System1_trial1, const
  ...
  (SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Engine_Vehicle_CVT_Wit_System1_trial1 = 0U;
}
   ...
   char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Engine_Vehicle_CVT_Wit_System1_trial1), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Engine_Vehicle_CVT_Wit_System1_trial1);
  return c3_y;
}
...
void sf_c3_Engine_Vehicle_CVT_Wit_System1_trial1_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_Engine_Vehicle_CVT_Wit_System1_trial1_get_post_codegen_info(void);
...
mxArray *sf_c3_Engine_Vehicle_CVT_Wit_System1_trial1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_Engine_Vehicle_CVT_Wit_System1_trial1_jit_fallback_info(void)
{
...
mxArray *sf_c3_Engine_Vehicle_CVT_Wit_System1_trial1_updateBuildInfo_args_info
  (void)
{
...
static void sf_opaque_initialize_c3_Engine_Vehicle_CVT_Wit_System1_trial1(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c3_Engine_Vehicle_CVT_Wit_System1_trial1
    ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
     chartInstanceVar);
  initialize_c3_Engine_Vehicle_CVT_Wit_System1_trial1
    ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c3_Engine_Vehicle_CVT_Wit_System1_trial1(void
  *chartInstanceVar)
{
  enable_c3_Engine_Vehicle_CVT_Wit_System1_trial1
    ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c3_Engine_Vehicle_CVT_Wit_System1_trial1(void
  *chartInstanceVar)
{
  disable_c3_Engine_Vehicle_CVT_Wit_System1_trial1
    ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c3_Engine_Vehicle_CVT_Wit_System1_trial1(void
  *chartInstanceVar)
{
  sf_gateway_c3_Engine_Vehicle_CVT_Wit_System1_trial1
    ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
     chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c3_Engine_Vehicle_CVT_Wit_System1_trial1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_Engine_Vehicle_CVT_Wit_System1_trial1
    ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_Engine_Vehicle_CVT_Wit_System1_trial1
    ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_Engine_Vehicle_CVT_Wit_System1_trial1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Engine_Vehicle_CVT_Wit_System1_trial1_optimization_info();
    }

    finalize_c3_Engine_Vehicle_CVT_Wit_System1_trial1
      ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc3_Engine_Vehicle_CVT_Wit_System1_trial1
    ((SFc3_Engine_Vehicle_CVT_Wit_System1_trial1InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Engine_Vehicle_CVT_Wit_System1_trial1
  (SimStruct *S)
{
  int i;
...
static void mdlRTW_c3_Engine_Vehicle_CVT_Wit_System1_trial1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
void c3_Engine_Vehicle_CVT_Wit_System1_trial1_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Engine_Vehicle_CVT_Wit_System1_trial1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Engine_Vehicle_CVT_Wit_System1_trial1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Engine_Vehicle_CVT_Wit_System1_trial1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Engine_Vehicle_CVT_Wit_System1_trial1_method_dispatcher.\n"
