...
MACHINE     = EV_Pwr_Manager
TARGET      = sfun
CHART_SRCS 	= c2_EV_Pwr_Manager.c
MACHINE_SRC	= EV_Pwr_Manager_sfun.c
MACHINE_REG = EV_Pwr_Manager_sfun_registry.c
MAKEFILE    = EV_Pwr_Manager_sfun.mak
...
OBJLIST_FILE = EV_Pwr_Manager_sfun.mol
