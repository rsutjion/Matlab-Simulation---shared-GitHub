...
{
  extern unsigned int
    sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern void
    sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_uses_exported_functions( int
  ...
  if (strcmp(machineName, "Engine_Vehicle_CVT_RS_System1_SpeedTrack") == 0) {
    sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_uses_exported_functions(nlhs,
      plhs, nrhs-2, prhs+2);
    return 1;
  }
...
{
  extern unsigned int
    sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Engine_Vehicle_CVT_RS_System1_SpeedTrack") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Engine_Vehicle_CVT_RS_System1_SpeedTrack") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Engine_Vehicle_CVT_RS_System1_SpeedTrack") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_jit_fallback_info(nlhs,
      plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Engine_Vehicle_CVT_RS_System1_SpeedTrack") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_get_post_codegen_info(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "Engine_Vehicle_CVT_RS_System1_SpeedTrack") == 0) {
    sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_get_post_codegen_info(nlhs, plhs,
      nrhs-2, prhs+2);
    return 1;
  }
...
extern unsigned int
  sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Engine_Vehicle_CVT_RS_System1_SpeedTrack")) {
    return(sf_Engine_Vehicle_CVT_RS_System1_SpeedTrack_method_dispatcher
...
extern void Engine_Vehicle_CVT_RS_System1_SpeedTrack_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Engine_Vehicle_CVT_RS_System1_SpeedTrack_terminator();
...
extern void Engine_Vehicle_CVT_RS_System1_SpeedTrack_initializer(void);
extern void Engine_Vehicle_CVT_RS_System1_SpeedTrack_register_exported_symbols
  (SimStruct* S);
extern void Engine_Vehicle_CVT_RS_System1_SpeedTrack_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Engine_Vehicle_CVT_RS_System1_SpeedTrack_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Engine_Vehicle_CVT_RS_System1_SpeedTrack_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Engine_Vehicle_CVT_RS_System1_SpeedTrack_initializer();
  }
