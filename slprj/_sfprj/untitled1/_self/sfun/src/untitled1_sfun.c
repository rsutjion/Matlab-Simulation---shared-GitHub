...
extern void sf_untitled1_uses_exported_functions(int nlhs, mxArray * plhs[], int
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1937334151U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1740145474U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3567213541U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4174869603U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1139718266U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2162102903U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1244405062U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(463603362U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "aFs7AQ2j88PwhXKuF631KC") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "RKnSpllrm7sShSODZFOToB") == 0) {
...
void sf_untitled1_get_post_codegen_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   case 2:
    {
      if (strcmp(tpChksum, "RKnSpllrm7sShSODZFOToB") == 0) {
        extern mxArray *sf_c2_untitled1_get_post_codegen_info(void);
        plhs[0] = sf_c2_untitled1_get_post_codegen_info();
        return;
      }
    }
    break;
