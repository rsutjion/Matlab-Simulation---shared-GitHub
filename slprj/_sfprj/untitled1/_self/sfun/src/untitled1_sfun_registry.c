...
unsigned int sf_process_machine_uses_exported_functions_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern void sf_untitled1_uses_exported_functions( int nlhs, mxArray * plhs[],
  ...
  if (strcmp(machineName, "untitled1") == 0) {
    sf_untitled1_uses_exported_functions(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_untitled1_get_post_codegen_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "untitled1") == 0) {
    sf_untitled1_get_post_codegen_info(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
