...
#include "c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2.h"
...
static void initialize_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void initialize_params_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void enable_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void disable_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Engine_Vehicle_CVT_RS_System1_StartS
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void set_sim_state_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance,
   const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_Engine_Vehicle_CVT_RS_System1_S
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void finalize_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void sf_gateway_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void mdl_start_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
static void initSimStructsc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance);
...
static uint8_T c3_e_emlrt_marshallIn
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance,
   const mxArray *c3_b_is_active_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2,
  ...
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2 = 0U;
}
  ...
  (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal =
    chartInstance->c3_is_active_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
   ...
   const mxArray *c3_st)
{
  ...
  *chartInstance->c3_ClutchON = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2 =
    ...
    "is_active_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2");
  ...
  c3_update_debugger_state_c3_Engine_Vehicle_CVT_RS_System1_StartS(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance;
  chartInstance = (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct
                   *)chartInstanceVoid;
...
const mxArray
  *sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_get_eml_resolved_functions_info
  (void)
{
   ...
   const char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2);
  return c3_y;
}
...
void sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_get_check_sum(mxArray
  *plhs[])
{
...
mxArray* sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_get_post_codegen_info
  (void);
mxArray
  *sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_get_autoinheritance_info
  (void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_get_post_codegen_info();
...
mxArray *sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_third_party_uses_info
  (void)
{
...
mxArray *sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_jit_fallback_info(void)
{
...
mxArray
  *sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[13],T\"ClutchON\",},{M[8],M[0],T\"is_active_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance =
      (SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *)
...
static void sf_opaque_initialize_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
    ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
     chartInstanceVar);
  initialize_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
    ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(void *
  chartInstanceVar)
{
  enable_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
    ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(void
  *chartInstanceVar)
{
  disable_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
    ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(void
  *chartInstanceVar)
{
  sf_gateway_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
    ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
     chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
    ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void
  sf_opaque_set_sim_state_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
    ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
      ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
    ((SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(SimStruct *S)
{
  SFc3_Engine_Vehicle_CVT_RS_System1_StartStop_v2InstanceStruct *chartInstance;
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2;
...
void c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_method_dispatcher(SimStruct
  *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Engine_Vehicle_CVT_RS_System1_StartStop_v2_method_dispatcher.\n"
