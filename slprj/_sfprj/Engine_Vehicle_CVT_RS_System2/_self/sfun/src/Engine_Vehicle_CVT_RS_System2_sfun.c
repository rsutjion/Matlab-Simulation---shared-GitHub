  ...
  method, void *data)
{
  ...
  if (chartFileNumber==3) {
    c3_Engine_Vehicle_CVT_RS_System2_method_dispatcher(simstructPtr, method,
      data);
    return 1;
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3097190196U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(374377998U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1864219439U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2008778926U);
      ...
      switch (chartFileNumber) {
       ...
       case 3:
        {
          extern void sf_c3_Engine_Vehicle_CVT_RS_System2_get_check_sum(mxArray *
            plhs[]);
          sf_c3_Engine_Vehicle_CVT_RS_System2_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(876300717U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1042866741U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1891642170U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1927800080U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "7opRodR3K0lOrnpKN1yOQD") == 0) {
          extern mxArray
            *sf_c3_Engine_Vehicle_CVT_RS_System2_get_autoinheritance_info(void);
          plhs[0] = sf_c3_Engine_Vehicle_CVT_RS_System2_get_autoinheritance_info
            ();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        extern const mxArray
          *sf_c3_Engine_Vehicle_CVT_RS_System2_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c3_Engine_Vehicle_CVT_RS_System2_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "lmpsj9PAuGSEZKfeJJw1D") == 0) {
          extern mxArray
            *sf_c3_Engine_Vehicle_CVT_RS_System2_third_party_uses_info(void);
          plhs[0] = sf_c3_Engine_Vehicle_CVT_RS_System2_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "lmpsj9PAuGSEZKfeJJw1D") == 0) {
          extern mxArray *sf_c3_Engine_Vehicle_CVT_RS_System2_jit_fallback_info
            (void);
          plhs[0] = sf_c3_Engine_Vehicle_CVT_RS_System2_jit_fallback_info();
          break;
        }
      }
     ...
     case 3:
      {
        if (strcmp(tpChksum, "lmpsj9PAuGSEZKfeJJw1D") == 0) {
          extern mxArray
            *sf_c3_Engine_Vehicle_CVT_RS_System2_updateBuildInfo_args_info(void);
          plhs[0] =
            sf_c3_Engine_Vehicle_CVT_RS_System2_updateBuildInfo_args_info();
          break;
        }
      }
   ...
   case 3:
    {
      if (strcmp(tpChksum, "lmpsj9PAuGSEZKfeJJw1D") == 0) {
        extern mxArray
          *sf_c3_Engine_Vehicle_CVT_RS_System2_get_post_codegen_info(void);
        plhs[0] = sf_c3_Engine_Vehicle_CVT_RS_System2_get_post_codegen_info();
        return;
      }
    }
    break;
