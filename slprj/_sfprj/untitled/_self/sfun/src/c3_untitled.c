...
#define c3_IN_FailState                ((uint8_T)1U)
#define c3_IN_ON                       ((uint8_T)2U)
#define c3_IN_System_Initialization    ((uint8_T)3U)
...
static void c3_FailState(SFc3_untitledInstanceStruct *chartInstance);
static void c3_isequal(SFc3_untitledInstanceStruct *chartInstance);
...
static uint8_T c3_e_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_b_tp_System_Initialization, const char_T *c3_identifier);
...
static const mxArray *c3_j_emlrt_marshallIn(SFc3_untitledInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_updateDataWrittenToVector(SFc3_untitledInstanceStruct
  *chartInstance, uint32_T c3_vectorIndex);
static void c3_errorIfDataNotWrittenToFcn(SFc3_untitledInstanceStruct
...
static void initialize_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_tp_FailState = 0U;
  chartInstance->c3_tp_ON = 0U;
  chartInstance->c3_tp_System_Initialization = 0U;
  ...
  *chartInstance)
{
  ...
  real_T c3_d1;
  real_T c3_d2;
  sf_mex_import_named("GREEN", sf_mex_get_sfun_param(chartInstance->S, 0, 0),
                      &c3_d0, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c3_GREEN = c3_d0;
  sf_mex_import_named("ORANGE", sf_mex_get_sfun_param(chartInstance->S, 1, 0),
                      &c3_d1, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c3_ORANGE = c3_d1;
  sf_mex_import_named("RED", sf_mex_get_sfun_param(chartInstance->S, 2, 0),
                      &c3_d2, 0, 0, 0U, 0, 0U, 0);
  chartInstance->c3_RED = c3_d2;
}
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c3_is_c3_untitled == c3_IN_System_Initialization) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_untitled == c3_IN_ON) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_untitled == c3_IN_FailState) {
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = *chartInstance->c3_Light;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = *chartInstance->c3_partsFed;
  c3_b_u = c3_b_hoistedGlobal;
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_untitled;
  c3_c_u = c3_c_hoistedGlobal;
  c3_d_y = NULL;
  sf_mex_assign(&c3_d_y, sf_mex_create("y", &c3_c_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 2, c3_d_y);
  c3_d_hoistedGlobal = chartInstance->c3_is_c3_untitled;
  ...
  const mxArray *c3_st)
{
  ...
  *chartInstance->c3_Light = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 0)), "Light");
  *chartInstance->c3_partsFed = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 1)), "partsFed");
  ...
  (SFc3_untitledInstanceStruct *chartInstance)
{
  if (chartInstance->c3_doSetSimStateSideEffects != 0) {
    if (chartInstance->c3_is_c3_untitled == c3_IN_FailState) {
      chartInstance->c3_tp_FailState = 1U;
    } else {
      chartInstance->c3_tp_FailState = 0U;
    }
    ...
    if (chartInstance->c3_is_c3_untitled == c3_IN_System_Initialization) {
      chartInstance->c3_tp_System_Initialization = 1U;
...
static void sf_gateway_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  for (c3_i2 = 0; c3_i2 < 3; c3_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_sensors)[c3_i2], 0U);
  }

  _SFD_DATA_RANGE_CHECK(chartInstance->c3_GREEN, 1U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c3_ORANGE, 2U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c3_RED, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_partsFed, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Light, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Alarm, 6U);
  chartInstance->c3_sfEvent = CALL_EVENT;
...
static void c3_chartstep_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_untitled == 0U) {
    ...
    chartInstance->c3_is_c3_untitled = c3_IN_System_Initialization;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
    chartInstance->c3_temporalCounter_i1 = 0.0;
    chartInstance->c3_tp_System_Initialization = 1U;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 1U, c3_sf_marshallOut,
      c3_sf_marshallIn);
    *chartInstance->c3_Light = chartInstance->c3_ORANGE;
    c3_updateDataWrittenToVector(chartInstance, 1U);
    _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Light, 5U);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
    switch (chartInstance->c3_is_c3_untitled) {
     case c3_IN_FailState:
      CV_CHART_EVAL(0, 0, 1);
      c3_FailState(chartInstance);
      break;
     ...
     case c3_IN_ON:
      ...
      c3_out = CV_EML_IF(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0,
        *chartInstance->c3_Alarm, 1.0, -1, 0U, *chartInstance->c3_Alarm == 1.0));
      _SFD_SYMBOL_SCOPE_POP();
      if (c3_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_ON = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_untitled = c3_IN_FailState;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_FailState = 1U;
        ...
        *chartInstance->c3_Light = chartInstance->c3_RED;
        c3_updateDataWrittenToVector(chartInstance, 1U);
        _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Light, 5U);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
        ...
        for (c3_i3 = 0; c3_i3 < 3; c3_i3++) {
          c3_x[c3_i3] = ((*chartInstance->c3_sensors)[c3_i3] >= 2.0);
        }
        ...
        c3_k = 0;
        exitg2 = false;
        while ((exitg2 == false) && (c3_k < 3)) {
          c3_b_k = 1.0 + (real_T)c3_k;
          if ((real_T)c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", c3_b_k), 1, 3, 1, 0) - 1] == 0.0) {
            c3_b0 = true;
          } else {
        ...
        if (CV_EML_IF(1, 1, 0, c3_y)) {
          (*chartInstance->c3_partsFed)++;
          c3_updateDataWrittenToVector(chartInstance, 0U);
          _SFD_DATA_RANGE_CHECK(*chartInstance->c3_partsFed, 4U);
        } else {
          c3_errorIfDataNotWrittenToFcn(chartInstance, 0U, 4U, 2U, 83, 8);
        }
     ...
     case c3_IN_System_Initialization:
      CV_CHART_EVAL(0, 0, 3);
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_out, 2U, c3_b_sf_marshallOut,
        c3_b_sf_marshallIn);
      c3_b_out = CV_EML_IF(1, 0, 0, chartInstance->c3_temporalCounter_i1 +
      ...
      if (c3_b_out) {
        ...
        *chartInstance->c3_Light = chartInstance->c3_RED;
        ...
        for (c3_i4 = 0; c3_i4 < 3; c3_i4++) {
          c3_x[c3_i4] = ((*chartInstance->c3_sensors)[c3_i4] > 0.0);
        }
        ...
        c3_c_k = 0;
        exitg1 = false;
        while ((exitg1 == false) && (c3_c_k < 3)) {
          c3_d_k = 1.0 + (real_T)c3_c_k;
          if ((real_T)c3_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
               _SFD_INTEGER_CHECK("", c3_d_k), 1, 3, 1, 0) - 1] == 0.0) {
            c3_b_y = false;
            exitg1 = true;
          } else {
            c3_c_k++;
        ...
        c3_c_out = CV_EML_IF(3, 0, 0, c3_b_y);
        _SFD_SYMBOL_SCOPE_POP();
        if (c3_c_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
          chartInstance->c3_tp_System_Initialization = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
          chartInstance->c3_is_c3_untitled = c3_IN_ON;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
          chartInstance->c3_tp_ON = 1U;
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_h_nargout, 1U,
            c3_sf_marshallOut, c3_sf_marshallIn);
          *chartInstance->c3_Light = chartInstance->c3_GREEN;
          c3_updateDataWrittenToVector(chartInstance, 1U);
          _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Light, 5U);
          *chartInstance->c3_partsFed = 0.0;
          c3_updateDataWrittenToVector(chartInstance, 0U);
          _SFD_DATA_RANGE_CHECK(*chartInstance->c3_partsFed, 4U);
          _SFD_SYMBOL_SCOPE_POP();
        } else {
...
static void c3_FailState(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_out, 2U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  c3_out = CV_EML_IF(2, 0, 0, CV_RELATIONAL_EVAL(5U, 2U, 0,
    *chartInstance->c3_Alarm, 0.0, -1, 0U, *chartInstance->c3_Alarm == 0.0));
  _SFD_SYMBOL_SCOPE_POP();
  if (c3_out) {
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("any"), "name", "name", 0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/allOrAny.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1372604758U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/allOrAny.m"),
                  "context", "context", 5);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isequal"), "name", "name", 5);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/allOrAny.m"),
                  "context", "context", 8);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isnan"), "name", "name", 8);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("logical"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("all"), "name", "name", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("logical"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m"), "resolved",
                  "resolved", 10);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1372604014U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c3_b_tp_System_Initialization, const char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_tp_System_Initialization), &c3_thisId);
  sf_mex_destroy(&c3_b_tp_System_Initialization);
  return c3_y;
}
...
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_b_tp_System_Initialization;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  uint8_T c3_y;
  SFc3_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc3_untitledInstanceStruct *)chartInstanceVoid;
  c3_b_tp_System_Initialization = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
...
static void init_simulink_io_address(SFc3_untitledInstanceStruct *chartInstance)
{
  chartInstance->c3_sensors = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c3_partsFed = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c3_Light = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c3_Alarm = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3007027589U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1515708204U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1744481266U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2327492001U);
}
...
mxArray *sf_c3_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("zKC05UUiInmCVhYPYydcJF");
...
static const mxArray *sf_get_sim_state_info_c3_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[15],T\"Light\",},{M[1],M[14],T\"partsFed\",},{M[8],M[0],T\"is_active_c3_untitled\",},{M[9],M[0],T\"is_c3_untitled\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[1],M[1]}}},{M[13],M[0],T\"previousTime\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,10,0,0,"GREEN");
          _SFD_SET_DATA_PROPS(2,10,0,0,"ORANGE");
          _SFD_SET_DATA_PROPS(3,10,0,0,"RED");
          _SFD_SET_DATA_PROPS(4,2,0,1,"partsFed");
          _SFD_SET_DATA_PROPS(5,2,0,1,"Light");
          _SFD_SET_DATA_PROPS(6,1,1,0,"Alarm");
        ...
        _SFD_CV_INIT_EML_IF(1,1,0,47,67,-1,100);
        ...
        _SFD_CV_INIT_EML_RELATIONAL(4,0,0,1,11,-1,0);
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c3_sensors);
        _SFD_SET_DATA_VALUE_PTR(1U, &chartInstance->c3_GREEN);
        _SFD_SET_DATA_VALUE_PTR(2U, &chartInstance->c3_ORANGE);
        _SFD_SET_DATA_VALUE_PTR(3U, &chartInstance->c3_RED);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c3_partsFed);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c3_Light);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c3_Alarm);
      }
    } else {
...
static void mdlSetWorkWidths_c3_untitled(SimStruct *S)
{
  /* Actual parameters from chart:
     GREEN ORANGE RED
   */
  const char_T *rtParamNames[] = { "GREEN", "ORANGE", "RED" };
  ...
  /* registration for ORANGE*/
  ssRegDlgParamAsRunTimeParam(S, 1, 1, rtParamNames[1], SS_DOUBLE);

  /* registration for RED*/
  ...
  ssSetChecksum0(S,(3158436472U));
  ssSetChecksum1(S,(1489358227U));
  ssSetChecksum2(S,(4184399422U));
  ssSetChecksum3(S,(2462552145U));
